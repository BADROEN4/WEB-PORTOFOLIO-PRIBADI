                    ...
                    <div class="row gx-5 align-items-center">
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                <div class="badge bg-gradient-primary-to-secondary text-white mb-4"><div class="text-uppercase">Web Development &middot; App Development &middot; Digital Marketing &middot; System Analyst</div></div>
                                <div class="fs-3 fw-light text-muted">I can help your business to</div>
                                <div class="fs-3 fw-light text-muted">keep up with the times with digitalization.</div>
                                <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">WELCOME TO MY RESUME</span></h1>
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                    <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="resume">My Resume</a>
                                    <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder" href="project">My Projects</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-7">
                            ...
                            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div class="profile bg-gradient-primary-to-secondary">
                                    ...
                                    <img class="profile-img" src="assets/profile3.png" alt="..." />
                                    <div class="dots-1">
                                        <!-- SVG Dots-->
                        ...
                        <div class="col-xxl-8">
                            <div class="text-center my-5">
                                ...
                                <div class="d-flex justify-content-center fs-2 gap-4">
                                    ...
                                    <a class="text-gradient" href="https://www.linkedin.com/in/farhan-badru-tamam-work/"><i class="bi bi-linkedin"></i></a>
                                    <a class="text-gradient" href="https://github.com/BADROEN4"><i class="bi bi-github"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
